...
for epoch in range(server_model_epoch):
  ...
  #  server_model, models = communication(server_model, models, client_weights)
    ...
    server_model, models = communication_shared_layers_dropout_rate(
    ...
    server_volve_loss_acc_mse_mae.to_csv('./out0702/server/volve/server_volve_loss_acc_mse_mae.csv', sep=",", index=True)
    server_volve_pre_ture_test.to_csv('./out0702/server/volve/server_volve_pre_ture_test.csv', sep=",", index=True)
    server_xj_loss_acc_mse_mae.to_csv('./out0702/server/xj/server_xj_loss_acc_mse_mae.csv', sep=",", index=True)
    server_xj_pre_ture_test.to_csv('./out0702/server/xj/server_xj_pre_ture_test.csv', sep=",", index=True)
    server_bh_loss_acc_mse_mae.to_csv('./out0702/server/bh/server_bh_loss_acc_mse_mae.csv', sep=",", index=True)
    server_bh_pre_ture_test.to_csv('./out0702/server/bh/server_bh_pre_ture_test.csv', sep=",", index=True)

    clint0_volve_loss_acc_mse_mae.to_csv('./out0702/client/volve/clint0_volve_loss_acc_mse_mae.csv', sep=",", index=True)
    clint0_volve_pre_ture_test.to_csv('./out0702/client/volve/clint0_volve_pre_ture_test.csv', sep=",", index=True)
    clint1_xj_loss_acc_mse_mae.to_csv('./out0702/client/xj/clint1_xj_loss_acc_mse_mae.csv', sep=",", index=True)
    clint1_xj_pre_ture_test.to_csv('./out0702/client/xj/clint1_xj_pre_ture_test.csv', sep=",", index=True)
    clint2_bh_loss_acc_mse_mae.to_csv('./out0702/client/bh/clint2_bh_loss_acc_mse_mae.csv', sep=",", index=True)
    clint2_bh_pre_ture_test.to_csv('./out0702/client/bh/clint2_bh_pre_ture_test.csv', sep=",", index=True)

    acc_loss_plot_one(server_volve_loss_acc_mse_mae['test_loss'], 'loss','./out0702/server/volve/server_test_loss.png')
    acc_loss_plot_one(server_volve_loss_acc_mse_mae['test_r2'], 'r2', './out0702/server/volve/server_test_r2.png')
    acc_loss_plot_one(server_xj_loss_acc_mse_mae['test_loss'], 'loss','./out0702/server/xj/server_test_loss.png')
    acc_loss_plot_one(server_xj_loss_acc_mse_mae['test_r2'], 'r2', './out0702/server/xj/server_test_r2.png')
    acc_loss_plot_one(server_bh_loss_acc_mse_mae['test_loss'], 'loss','./out0702/server/bh/server_test_loss.png')
    acc_loss_plot_one(server_bh_loss_acc_mse_mae['test_r2'], 'r2', './out0702/server/bh/server_test_r2.png')

    acc_loss_plot_two(clint0_volve_loss_acc_mse_mae['train_r2'], clint0_volve_loss_acc_mse_mae['test_r2'], 'r2','./out0702/client/volve/clint0_volve_r2.png')
    acc_loss_plot_two(clint0_volve_loss_acc_mse_mae['train_loss'], clint0_volve_loss_acc_mse_mae['test_loss'], 'r2','./out0702/client/volve/clint0_volve_loss.png')
    acc_loss_plot_two(clint1_xj_loss_acc_mse_mae['train_r2'], clint1_xj_loss_acc_mse_mae['test_r2'], 'r2','./out0702/client/xj/clint1_xj_r2.png')
    acc_loss_plot_two(clint1_xj_loss_acc_mse_mae['train_loss'], clint1_xj_loss_acc_mse_mae['test_loss'], 'r2','./out0702/client/xj/clint1_xj_loss.png')
    acc_loss_plot_two(clint2_bh_loss_acc_mse_mae['train_r2'], clint2_bh_loss_acc_mse_mae['test_r2'], 'r2','./out0702/client/bh/clint2_bh_r2.png')
    acc_loss_plot_two(clint2_bh_loss_acc_mse_mae['train_loss'], clint2_bh_loss_acc_mse_mae['test_loss'], 'r2','./out0702/client/bh/clint2_bh_loss.png')

    true_test_plot(server_volve_pre_ture_test['depth'], server_volve_pre_ture_test['true'], server_volve_pre_ture_test['pre'], 'test',
                   './out0702/server/volve/server_volve_pre_ture_test.png')
    true_test_plot(server_xj_pre_ture_test['depth'], server_xj_pre_ture_test['true'], server_xj_pre_ture_test['pre'], 'test',
                   './out0702/server/xj/server_xj_pre_ture_test.png')
    true_test_plot(server_bh_pre_ture_test['depth'], server_bh_pre_ture_test['true'], server_bh_pre_ture_test['pre'], 'test',
                   './out0702/server/bh/server_bh_pre_ture_test.png')
    true_test_plot(clint0_volve_pre_ture_test['depth'], clint0_volve_pre_ture_test['true'], clint0_volve_pre_ture_test['pre'], 'test',
                   './out0702/client/volve/clint0_volve_pre_ture_test.png')
    true_test_plot(clint1_xj_pre_ture_test['depth'], clint1_xj_pre_ture_test['true'], clint1_xj_pre_ture_test['pre'], 'test',
                   './out0702/client/xj/clint1_xj_pre_ture_test.png')
    true_test_plot(clint2_bh_pre_ture_test['depth'], clint2_bh_pre_ture_test['true'], clint2_bh_pre_ture_test['pre'], 'test',
                   './out0702/client/bh/clint2_bh_pre_ture_test.png')

    torch.save(models[0].state_dict(), './out0702/model/model_0_volve.pkl')
    torch.save(models[1].state_dict(), './out0702/model/model_1_xj.pkl')
    torch.save(models[2].state_dict(), './out0702/model/model_2_bh.pkl')
    print('save clint model')
    torch.save(server_model.state_dict(), './out0702/model/server_model.pkl')

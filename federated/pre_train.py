...
volve_train,volve_train_y_max,volve_train_y_min, volve_train_de_max,volve_train_de_min = data_load(volve_10)
volve_test,volve_test_y_max,volve_test_y_min, volve_test_de_max,volve_test_de_min =  data_load(volve_12)

xj_train,xj_train_y_max,xj_train_y_min, xj_train_de_max,xj_train_de_min =  data_load(xj_3)
xj_test,xj_test_y_max,xj_test_y_min, xj_test_de_max,xj_test_de_min =  data_load(xj_2)

bh_train,bh_train_y_max,bh_train_y_min, bh_train_de_max,bh_train_de_min =  data_load(bh_10)
bh_test,bh_test_y_max,bh_test_y_min, bh_test_de_max,bh_test_de_min =  data_load(bh_6)
...
optimizers = [optim.Adam(params=models[idx].parameters(), lr=args.tf_lr, weight_decay=0.001) for idx in range(client_num)]
...
for epoch in range(2):
    ...
    # server_volve_test_acc, server_volve_test_r2, server_volve_test_mse, server_volve_test_mae,server_volve_test_loss, server_volve_true_test,\
    # server_volve_pre_test, server_volve_test_depth = test(server_model, volve_test,test_y_max[0],test_y_min[0], test_de_max[0],test_de_min[0])
    #
    # server_xj_test_acc, server_xj_test_r2, server_xj_test_mse, server_xj_test_mae, server_xj_test_loss, server_xj_true_test, \
    # server_xj_pre_test, server_xj_test_depth = test(server_model, xj_test, test_y_max[1], test_y_min[1],
    #                                                       test_de_max[1], test_de_min[1])
    #
    # server_bh_test_acc, server_bh_test_r2, server_bh_test_mse, server_bh_test_mae, server_bh_test_loss, server_bh_true_test, \
    # server_bh_pre_test, server_bh_test_depth = test(server_model, bh_test, test_y_max[2], test_y_min[2],
    #                                                       test_de_max[2], test_de_min[2])
    #
    #
    # loss_acc_r2_mse_mae_metrics['server_model']['test_volve']['acc_size'].append(server_volve_test_acc)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_volve']['r2_size'].append(server_volve_test_r2)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_volve']['mse_size'].append(server_volve_test_mse)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_volve']['mae_size'].append(server_volve_test_mae)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_volve']['loss_size'].append(server_volve_test_loss)
    #
    # loss_acc_r2_mse_mae_metrics['server_model']['test_xj']['acc_size'].append(server_xj_test_acc)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_xj']['r2_size'].append(server_xj_test_r2)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_xj']['mse_size'].append(server_xj_test_mse)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_xj']['mae_size'].append(server_xj_test_mae)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_xj']['loss_size'].append(server_xj_test_loss)
    #
    # loss_acc_r2_mse_mae_metrics['server_model']['test_bh']['acc_size'].append(server_bh_test_acc)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_bh']['r2_size'].append(server_bh_test_r2)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_bh']['mse_size'].append(server_bh_test_mse)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_bh']['mae_size'].append(server_bh_test_mae)
    # loss_acc_r2_mse_mae_metrics['server_model']['test_bh']['loss_size'].append(server_bh_test_loss)
    ...
    server_volve_loss_acc_mse_mae.to_csv('./output/server/volve/server_volve_loss_acc_mse_mae.csv', sep=",", index=True)
    server_volve_pre_ture_test.to_csv('./output/server/volve/server_volve_pre_ture_test.csv', sep=",", index=True)
    server_xj_loss_acc_mse_mae.to_csv('./output/server/xj/server_xj_loss_acc_mse_mae.csv', sep=",", index=True)
    server_xj_pre_ture_test.to_csv('./output/server/xj/server_xj_pre_ture_test.csv', sep=",", index=True)
    server_bh_loss_acc_mse_mae.to_csv('./output/server/bh/server_bh_loss_acc_mse_mae.csv', sep=",", index=True)
    server_bh_pre_ture_test.to_csv('./output/server/bh/server_bh_pre_ture_test.csv', sep=",", index=True)

    clint0_volve_loss_acc_mse_mae.to_csv('./output/client/volve/clint0_volve_loss_acc_mse_mae.csv', sep=",", index=True)
    clint0_volve_pre_ture_test.to_csv('./output/client/volve/clint0_volve_pre_ture_test.csv', sep=",", index=True)
    clint1_xj_loss_acc_mse_mae.to_csv('./output/client/xj/clint1_xj_loss_acc_mse_mae.csv', sep=",", index=True)
    clint1_xj_pre_ture_test.to_csv('./output/client/xj/clint1_xj_pre_ture_test.csv', sep=",", index=True)
    clint2_bh_loss_acc_mse_mae.to_csv('./output/client/bh/clint2_bh_loss_acc_mse_mae.csv', sep=",", index=True)
    clint2_bh_pre_ture_test.to_csv('./output/client/bh/clint2_bh_pre_ture_test.csv', sep=",", index=True)

    acc_loss_plot_one(server_volve_loss_acc_mse_mae['test_loss'], 'loss','./output/server/volve/server_test_loss.png')
    acc_loss_plot_one(server_volve_loss_acc_mse_mae['test_r2'], 'r2', './output/server/volve/server_test_r2.png')
    acc_loss_plot_one(server_xj_loss_acc_mse_mae['test_loss'], 'loss','./output/server/xj/server_test_loss.png')
    acc_loss_plot_one(server_xj_loss_acc_mse_mae['test_r2'], 'r2', './output/server/xj/server_test_r2.png')
    acc_loss_plot_one(server_bh_loss_acc_mse_mae['test_loss'], 'loss','./output/server/bh/server_test_loss.png')
    acc_loss_plot_one(server_bh_loss_acc_mse_mae['test_r2'], 'r2', './output/server/bh/server_test_r2.png')

    acc_loss_plot_two(clint0_volve_loss_acc_mse_mae['train_r2'], clint0_volve_loss_acc_mse_mae['test_r2'], 'r2','./output/client/volve/clint0_volve_r2.png')
    acc_loss_plot_two(clint0_volve_loss_acc_mse_mae['train_loss'], clint0_volve_loss_acc_mse_mae['test_loss'], 'r2','./output/client/volve/clint0_volve_loss.png')
    acc_loss_plot_two(clint1_xj_loss_acc_mse_mae['train_r2'], clint1_xj_loss_acc_mse_mae['test_r2'], 'r2','./output/client/xj/clint1_xj_r2.png')
    acc_loss_plot_two(clint1_xj_loss_acc_mse_mae['train_loss'], clint1_xj_loss_acc_mse_mae['test_loss'], 'r2','./output/client/xj/clint1_xj_loss.png')
    acc_loss_plot_two(clint2_bh_loss_acc_mse_mae['train_r2'], clint2_bh_loss_acc_mse_mae['test_r2'], 'r2','./output/client/bh/clint2_bh_r2.png')
    acc_loss_plot_two(clint2_bh_loss_acc_mse_mae['train_loss'], clint2_bh_loss_acc_mse_mae['test_loss'], 'r2','./output/client/bh/clint2_bh_loss.png')

    true_test_plot(server_volve_pre_ture_test['depth'], server_volve_pre_ture_test['true'], server_volve_pre_ture_test['pre'], 'test',
                   './output/server/volve/server_volve_pre_ture_test.png')
    true_test_plot(server_xj_pre_ture_test['depth'], server_xj_pre_ture_test['true'], server_xj_pre_ture_test['pre'], 'test',
                   './output/server/xj/server_xj_pre_ture_test.png')
    true_test_plot(server_bh_pre_ture_test['depth'], server_bh_pre_ture_test['true'], server_bh_pre_ture_test['pre'], 'test',
                   './output/server/bh/server_bh_pre_ture_test.png')
    true_test_plot(clint0_volve_pre_ture_test['depth'], clint0_volve_pre_ture_test['true'], clint0_volve_pre_ture_test['pre'], 'test',
                   './output/client/volve/clint0_volve_pre_ture_test.png')
    true_test_plot(clint1_xj_pre_ture_test['depth'], clint1_xj_pre_ture_test['true'], clint1_xj_pre_ture_test['pre'], 'test',
                   './output/client/xj/clint1_xj_pre_ture_test.png')
    true_test_plot(clint2_bh_pre_ture_test['depth'], clint2_bh_pre_ture_test['true'], clint2_bh_pre_ture_test['pre'], 'test',
                   './output/client/bh/clint2_bh_pre_ture_test.png')

    torch.save(models[0].state_dict(), './output/model/model_0_volve.pkl')
    torch.save(models[1].state_dict(), './output/model/model_1_xj.pkl')
    torch.save(models[2].state_dict(), './output/model/model_2_bh.pkl')
    print('save clint model')
    torch.save(server_model.state_dict(), './output/model/server_model.pkl')

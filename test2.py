...
data_dataloader,y_max,y_min, de_max,de_min = data_load(bh_16)

model=TransAm().to(device)
model_Path = "./output/model/server_model.pkl"
...
def initiate():
    ...
    acc_mse_mae.to_csv('./output/test/bh/300_300/acc_mse_mae_bh_16.csv', sep=",", index=True)

    csv_test.to_csv('./output/test/bh/300_300/rel_pre_test_bh_16.csv', sep=",", index=True)

    true_test_plot(csv_test['test_depth'], csv_test['test_true'], csv_test['test_pre'], 'test',
                   './output/test/bh/300_300/bh_16.png')

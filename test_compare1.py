...
def initiate():
    ...
    # acc_mse_mae.to_csv('./compare/xj1/test/300_300/acc_mse_mae_xj_1.csv', sep=",", index=True)
    #
    # csv_test.to_csv('./compare/xj1/test/300_300/rel_pre_test_volve_4.csv', sep=",", index=True)
    #
    # true_test_plot(csv_test['test_depth'], csv_test['test_true'], csv_test['test_pre'], 'test',
    #                './compare/xj1/test/300_300/xj_1.png')

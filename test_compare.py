...
data_dataloader,y_max,y_min, de_max,de_min = data_load(xj_2)

model=TransAm().to(device)
model_Path = "./compare/xj1/model/Model_xj.pkl"
...
def initiate():
    ...
    # acc_mse_mae.to_csv('./output/test/xj/300_1/acc_mse_mae_xj_2.csv', sep=",", index=True)
    #
    # csv_test.to_csv('./output/test/xj/300_1/rel_pre_test_xj_2.csv', sep=",", index=True)
    #
    # true_test_plot(csv_test['test_depth'], csv_test['test_true'], csv_test['test_pre'], 'test',
    #                './output/test/xj/300_1/xj_2.png')
    # acc_mse_mae.to_csv('./output/test/volve/300_300/acc_mse_mae_volve_15A.csv', sep=",", index=True)
    #
    # csv_test.to_csv('./output/test/volve/300_300/rel_pre_test_volve_15A.csv', sep=",", index=True)
    #
    # true_test_plot(csv_test['test_depth'], csv_test['test_true'], csv_test['test_pre'], 'test',
    #                './output/test/volve/300_300/volve_15A.png')
    acc_mse_mae.to_csv('./compare/xj1/test/300_300/acc_mse_mae_xj_2.csv', sep=",", index=True)

    csv_test.to_csv('./compare/xj1/test/300_300/rel_pre_test_xj_2.csv', sep=",", index=True)

    true_test_plot(csv_test['test_depth'], csv_test['test_true'], csv_test['test_pre'], 'test',
                   './compare/xj1/test/300_300/xj_2.png')
